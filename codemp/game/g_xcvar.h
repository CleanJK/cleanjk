...
#ifdef _DEBUG
XCVAR_DEF( bot_debugmessages,           "0",           NULL, CVAR_CHEAT,                                      qtrue )
XCVAR_DEF( bot_getinthecarrr,           "0",           NULL, CVAR_NONE,                                       qtrue )
XCVAR_DEF( bot_nogoals,                 "0",           NULL, CVAR_CHEAT,                                      qtrue )
...
XCVAR_DEF( bg_showEvents,               "0",           NULL, CVAR_NONE,                                       qfalse )
...
XCVAR_DEF( bot_normgpath,               "1",           NULL, CVAR_NONE,                                       qtrue )
XCVAR_DEF( bot_pvstype,                 "1",           NULL, CVAR_CHEAT,                                      qtrue )
XCVAR_DEF( bot_wp_clearweight,          "1",           NULL, CVAR_NONE,                                       qtrue )
XCVAR_DEF( bot_wp_distconnect,          "1",           NULL, CVAR_NONE,                                       qtrue )
...
XCVAR_DEF( g_spSkill,                   "3",           NULL, CVAR_ARCHIVE,                                    qtrue )
...
XCVAR_DEF( mapname,                     "",            NULL, CVAR_SERVERINFO | CVAR_ROM,                      qfalse )
...
XCVAR_DEF( session,                     "",            NULL, CVAR_INTERNAL | CVAR_ROM,                        qfalse )
XCVAR_DEF( se_language,                 "",            NULL, CVAR_NONE,                                       qfalse )
...
XCVAR_DEF( timescale,                   "1",           NULL, CVAR_CHEAT | CVAR_SYSTEMINFO,                    qtrue )
